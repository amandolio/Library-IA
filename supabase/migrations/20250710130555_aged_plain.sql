...
DROP POLICY IF EXISTS "Users can insert their own resources" ON public.academic_resources;
DROP POLICY IF EXISTS "Users can view their own resources" ON public.academic_resources;
DROP POLICY IF EXISTS "Users can update their own resources" ON public.academic_resources;
DROP POLICY IF EXISTS "Users can delete their own resources" ON public.academic_resources;
DROP POLICY IF EXISTS "Users can insert their own sync metadata" ON public.sync_metadata;
DROP POLICY IF EXISTS "Users can view their own sync metadata" ON public.sync_metadata;
DROP POLICY IF EXISTS "Users can update their own sync metadata" ON public.sync_metadata;
