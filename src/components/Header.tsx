...
export function Header({ user, onProfileClick, onSettingsClick }: HeaderProps) {
  const getRoleColor = (role: string) => {
    switch (role) {
      ...
      case 'faculty': return 'text-purple-600 bg-purple-50 dark:bg-purple-900/30 dark:text-purple-400';
      case 'student': return 'text-blue-600 bg-blue-50 dark:bg-blue-900/30 dark:text-blue-400';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <h1 className="ml-2 text-xl font-bold text-gray-900 dark:text-white">LibraryAI</h1>
          </div>
