...
export const mockResources: Resource[] = [
  ...
  // ==================== DOCUMENTOS CUBANOS Y EN ESPAÑOL ====================

  // INTELIGENCIA ARTIFICIAL - CUBA
  {
    id: 'cuba-ai-001',
    title: 'Inteligencia Artificial Aplicada a la Medicina en Cuba',
    authors: ['Dr. Carlos Pérez Rodríguez', 'Dra. María Elena Gómez'],
    type: 'journal',
    category: 'Inteligencia Artificial y Machine Learning',
    tags: ['IA', 'Medicina', 'Cuba', 'Salud Pública', 'Diagnóstico Automatizado'],
    abstract: 'Estudio sobre la implementación de sistemas de inteligencia artificial en el diagnóstico médico en hospitales cubanos. Incluye casos de éxito en la detección temprana de enfermedades mediante redes neuronales y análisis de imágenes médicas.',
    publishedYear: 2023,
    publisher: 'Revista Cubana de Informática Médica',
    citations: 145,
    impactFactor: 3.2,
    availability: 'digital-only',
    doi: '10.5281/cuba.rcim.2023.001',
    rating: 4.6,
    reviewCount: 78,
    language: 'es',
    pageCount: 28,
    thumbnail: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Medicina', 'Diagnóstico Automatizado', 'Deep Learning', 'Salud Pública'],
    digitalUrl: 'https://biblioteca.cuba.edu/revistas/rcim/ia-medicina-cuba.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-AI-001',
      barcode: 'CU31234567890200',
    ...
    fullTextKeywords: ['inteligencia artificial', 'medicina', 'cuba', 'diagnóstico', 'redes neuronales', 'análisis imágenes', 'salud pública', 'deep learning', 'detección temprana', 'hospitalización', 'radiología', 'tomografía']
  },
  {
    id: 'cuba-ai-002',
    title: 'Sistemas Inteligentes para la Gestión Agrícola en Cuba',
    authors: ['Ing. José Martínez', 'Dra. Ana Luisa Torres'],
    type: 'thesis',
    category: 'Inteligencia Artificial y Machine Learning',
    tags: ['IA', 'Agricultura', 'Cuba', 'Gestión Agrícola', 'Machine Learning'],
    abstract: 'Tesis doctoral sobre el desarrollo e implementación de sistemas de inteligencia artificial para optimizar la producción agrícola en Cuba. Incluye modelos predictivos para el rendimiento de cultivos, detección de plagas y optimización de recursos hídricos.',
    publishedYear: 2022,
    publisher: 'Universidad de La Habana',
    citations: 89,
    availability: 'available',
    location: 'Sección Tesis Cubanas, Estante 3',
    rating: 4.8,
    reviewCount: 34,
    language: 'es',
    pageCount: 185,
    thumbnail: 'https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Agricultura de Precisión', 'Machine Learning', 'Optimización', 'Sostenibilidad'],
    url: 'https://biblioteca.uh.cu/tesis/sistemas-inteligentes-agricultura',
    digitalUrl: 'https://biblioteca.uh.cu/tesis/sistemas-inteligentes-agricultura.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-AI-002',
      barcode: 'CU31234567890201',
    ...
    fullTextKeywords: ['sistemas inteligentes', 'agricultura', 'cuba', 'machine learning', 'predicción cultivos', 'plagas', 'recursos hídricos', 'optimización', 'producción agrícola', 'sostenibilidad', 'modelos predictivos']
  },
  {
    id: 'cuba-ai-003',
    title: 'Procesamiento de Lenguaje Natural para el Español Cubano',
    authors: ['Dr. Rafael Gutiérrez', 'MSc. Laura Fernández'],
    type: 'conference',
    category: 'Inteligencia Artificial y Machine Learning',
    tags: ['PLN', 'NLP', 'Español', 'Cuba', 'Lingüística Computacional'],
    abstract: 'Investigación sobre las particularidades del español cubano y su procesamiento mediante técnicas de PLN. Incluye corpus anotado, modelos de lenguaje específicos y aplicaciones en asistentes virtuales y traducción automática.',
    publishedYear: 2023,
    publisher: 'Conferencia Iberoamericana de Inteligencia Artificial',
    citations: 67,
    impactFactor: 2.8,
    availability: 'digital-only',
    rating: 4.5,
    ...
    pageCount: 12,
    thumbnail: 'https://images.pexels.com/photos/8386427/pexels-photo-8386427.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Lingüística Computacional', 'Modelos de Lenguaje', 'Dialectos', 'Chatbots'],
    digitalUrl: 'https://conferencias.iberoia.org/2023/pln-espanol-cubano.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-AI-003',
      barcode: 'CU31234567890202',
    ...
    fullTextKeywords: ['procesamiento lenguaje natural', 'español cubano', 'pln', 'lingüística computacional', 'corpus', 'modelos lenguaje', 'dialectos', 'asistentes virtuales', 'traducción automática', 'tokenización', 'análisis sintáctico']
  },

  // PROGRAMACIÓN - ESPAÑOL
  {
    id: 'es-prog-001',
    title: 'Fundamentos de Programación en Python: Guía Práctica en Español',
    authors: ['Ing. Miguel Ángel López', 'Lic. Carmen Rodríguez'],
    type: 'book',
    category: 'Programación y Desarrollo',
    tags: ['Python', 'Programación', 'Español', 'Tutorial', 'Principiantes'],
    abstract: 'Manual completo de programación en Python escrito en español, diseñado para estudiantes hispanohablantes. Incluye ejercicios prácticos, proyectos y ejemplos contextualizados para la realidad latinoamericana.',
    publishedYear: 2023,
    publisher: 'Editorial Universitaria Latinoamericana',
    citations: 234,
    availability: 'available',
    location: 'Sección Programación Español, Estante 1',
    ...
    pageCount: 520,
    thumbnail: 'https://images.pexels.com/photos/1181244/pexels-photo-1181244.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Programación Básica', 'Estructuras de Datos', 'Algoritmos', 'Desarrollo Web'],
    url: 'https://biblioteca.university.edu/catalog/python-fundamentos-espanol',
    digitalUrl: 'https://digital.library.edu/books/python-fundamentos-espanol.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-PROG-001',
      barcode: 'ES31234567890203',
    ...
    fullTextKeywords: ['python', 'programación', 'español', 'fundamentos', 'variables', 'funciones', 'clases', 'objetos', 'listas', 'diccionarios', 'control flujo', 'manejo errores', 'entrada salida', 'archivos']
  },
  {
    id: 'es-prog-002',
    title: 'Desarrollo Web Moderno con JavaScript: De Cero a Experto',
    authors: ['Ing. Fernando García', 'MSc. Patricia Méndez'],
    type: 'book',
    category: 'Programación y Desarrollo',
    tags: ['JavaScript', 'Desarrollo Web', 'React', 'Node.js', 'Español'],
    abstract: 'Libro completo sobre desarrollo web moderno con JavaScript, React y Node.js. Escrito en español con ejemplos prácticos y proyectos reales. Cubre desde fundamentos hasta arquitecturas avanzadas.',
    publishedYear: 2023,
    publisher: 'Ediciones Tecnológicas Hispanas',
    citations: 178,
    availability: 'digital-only',
    isbn: '978-84-987654-32-1',
    rating: 4.8,
    reviewCount: 389,
    language: 'es',
    pageCount: 680,
    thumbnail: 'https://images.pexels.com/photos/1181298/pexels-photo-1181298.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Frontend', 'Backend', 'Full Stack', 'APIs REST', 'Bases de Datos'],
    digitalUrl: 'https://digital.library.edu/books/desarrollo-web-javascript-espanol.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-PROG-002',
      barcode: 'ES31234567890204',
    ...
    fullTextKeywords: ['javascript', 'desarrollo web', 'react', 'node js', 'español', 'frontend', 'backend', 'full stack', 'api rest', 'express', 'mongodb', 'autenticación', 'despliegue']
  },

  // CIBERSEGURIDAD - CUBA
  {
    id: 'cuba-cyber-001',
    title: 'Ciberseguridad Nacional: Experiencias y Desafíos en Cuba',
    authors: ['Cnel. Ing. Roberto Sánchez', 'Dra. Isabel Castro'],
    type: 'book',
    category: 'Ciberseguridad y Criptografía',
    tags: ['Ciberseguridad', 'Cuba', 'Seguridad Nacional', 'Infraestructura Crítica'],
    abstract: 'Análisis exhaustivo de las políticas, estrategias y desafíos de ciberseguridad en Cuba. Incluye casos de estudio sobre protección de infraestructuras críticas, amenazas emergentes y colaboración internacional en materia de seguridad informática.',
    publishedYear: 2023,
    publisher: 'Editorial Ciencias Técnicas de Cuba',
    citations: 123,
    availability: 'available',
    location: 'Sección Seguridad Cubana, Estante 2',
    isbn: '978-959-05-1234-5',
    rating: 4.5,
    reviewCount: 67,
    language: 'es',
    pageCount: 345,
    thumbnail: 'https://images.pexels.com/photos/60504/security-protection-anti-virus-software-60504.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Seguridad Nacional', 'Ciberdefensa', 'Infraestructura Crítica', 'Políticas Públicas'],
    url: 'https://biblioteca.cuba.edu/catalog/ciberseguridad-nacional',
    digitalUrl: 'https://biblioteca.cuba.edu/digital/ciberseguridad-nacional.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-CYBER-001',
      barcode: 'CU31234567890205',
    ...
    fullTextKeywords: ['ciberseguridad', 'cuba', 'seguridad nacional', 'infraestructura crítica', 'amenazas', 'ciberdefensa', 'políticas', 'protección', 'incidentes', 'respuesta', 'cooperación internacional']
  },
  {
    id: 'cuba-cyber-002',
    title: 'Implementación de PKI en Organizaciones Cubanas',
    authors: ['MSc. Pedro Álvarez', 'Ing. Yolanda Martín'],
    type: 'journal',
    category: 'Ciberseguridad y Criptografía',
    tags: ['PKI', 'Criptografía', 'Cuba', 'Certificados Digitales', 'Firma Digital'],
    abstract: 'Guía práctica para la implementación de Infraestructuras de Clave Pública (PKI) en organizaciones cubanas. Incluye aspectos legales, técnicos y operacionales, así como casos de éxito en entidades gubernamentales y empresariales.',
    publishedYear: 2022,
    publisher: 'Revista Cubana de Ciencias Informáticas',
    citations: 56,
    impactFactor: 2.1,
    availability: 'digital-only',
    doi: '10.5281/cuba.rcci.2022.008',
    rating: 4.3,
    reviewCount: 34,
    language: 'es',
    pageCount: 18,
    thumbnail: 'https://images.pexels.com/photos/60506/security-protection-anti-virus-software-60506.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Criptografía', 'Firma Digital', 'Autenticación', 'Certificados'],
    digitalUrl: 'https://revista.tic.cu/index.php/rcci/article/view/pki-organizaciones',
    librarySystem: {
      catalogId: 'CAT-CUBA-CYBER-002',
      barcode: 'CU31234567890206',
    ...
    fullTextKeywords: ['pki', 'infraestructura clave pública', 'certificados digitales', 'firma digital', 'cuba', 'criptografía', 'autenticación', 'autoridad certificación', 'gestión claves', 'seguridad']
  },

  // CIENCIA DE DATOS - ESPAÑOL
  {
    id: 'es-data-001',
    title: 'Ciencia de Datos con Python: Análisis y Visualización',
    authors: ['Dr. Antonio Fernández', 'Dra. Beatriz Morales'],
    type: 'book',
    category: 'Ciencia de Datos y Analytics',
    tags: ['Ciencia de Datos', 'Python', 'Pandas', 'Matplotlib', 'Español'],
    abstract: 'Libro completo sobre ciencia de datos con Python, enfocado en análisis exploratorio y visualización. Incluye casos de estudio con datos latinoamericanos y ejemplos aplicados a problemas reales de la región.',
    publishedYear: 2023,
    publisher: 'Editorial Data Science Hispana',
    citations: 267,
    availability: 'available',
    location: 'Sección Ciencia Datos Español, Estante 1',
    isbn: '978-84-456789-01-2',
    rating: 4.9,
    reviewCount: 512,
    language: 'es',
    pageCount: 598,
    thumbnail: 'https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Análisis de Datos', 'Visualización', 'Machine Learning', 'Big Data'],
    url: 'https://biblioteca.university.edu/catalog/ciencia-datos-python-espanol',
    digitalUrl: 'https://digital.library.edu/books/ciencia-datos-python.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-DATA-001',
      barcode: 'ES31234567890207',
    ...
    fullTextKeywords: ['ciencia datos', 'python', 'pandas', 'matplotlib', 'numpy', 'análisis exploratorio', 'visualización', 'estadística', 'limpieza datos', 'transformación', 'gráficos', 'dashboards']
  },
  {
    id: 'es-data-002',
    title: 'Big Data y Analytics: Fundamentos y Aplicaciones Prácticas',
    authors: ['Ing. Carlos Ramírez', 'MSc. Diana Ortiz'],
    type: 'book',
    category: 'Ciencia de Datos y Analytics',
    tags: ['Big Data', 'Analytics', 'Hadoop', 'Spark', 'Español'],
    abstract: 'Manual completo sobre tecnologías y técnicas de Big Data y Analytics. Escrito en español con casos de uso empresariales de Latinoamérica. Cubre desde arquitecturas distribuidas hasta análisis en tiempo real.',
    publishedYear: 2022,
    publisher: 'Ediciones Analíticas Latam',
    citations: 189,
    availability: 'digital-only',
    isbn: '978-84-789012-34-5',
    rating: 4.6,
    reviewCount: 234,
    language: 'es',
    pageCount: 645,
    thumbnail: 'https://images.pexels.com/photos/1181673/pexels-photo-1181673.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Hadoop', 'Spark', 'Data Warehousing', 'Streaming', 'NoSQL'],
    digitalUrl: 'https://digital.library.edu/books/big-data-analytics-espanol.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-DATA-002',
      barcode: 'ES31234567890208',
    ...
    fullTextKeywords: ['big data', 'analytics', 'hadoop', 'spark', 'arquitecturas distribuidas', 'procesamiento paralelo', 'data lake', 'data warehouse', 'nosql', 'streaming', 'tiempo real', 'mapreduce']
  },

  // SISTEMAS - CUBA
  {
    id: 'cuba-sys-001',
    title: 'Nova: Sistema Operativo Libre Cubano',
    authors: ['Ing. Alejandro Cruz', 'Colectivo de Desarrollo Nova'],
    type: 'book',
    category: 'Sistemas y Redes',
    tags: ['Nova', 'Linux', 'Cuba', 'Sistema Operativo', 'Software Libre'],
    abstract: 'Documentación completa del sistema operativo Nova, basado en GNU/Linux y desarrollado en Cuba. Incluye guías de instalación, configuración, administración y desarrollo de aplicaciones específicas para el entorno cubano.',
    publishedYear: 2023,
    publisher: 'CITMATEL - Centro de Tecnologías Libres',
    citations: 234,
    availability: 'available',
    location: 'Sección Sistemas Cubanos, Estante 1',
    isbn: '978-959-05-2345-6',
    rating: 4.7,
    reviewCount: 178,
    language: 'es',
    pageCount: 456,
    thumbnail: 'https://images.pexels.com/photos/1148820/pexels-photo-1148820.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Linux', 'Software Libre', 'Administración de Sistemas', 'Debian'],
    url: 'https://www.nova.cu/documentacion',
    digitalUrl: 'https://www.nova.cu/documentacion/manual-nova.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-SYS-001',
      barcode: 'CU31234567890209',
      acquisitionDate: '2023-05-10',
      lastUpdated: '2024-02-06',
      totalCopies: 5,
      availableCopies: 3,
    ...
    fullTextKeywords: ['nova', 'linux', 'debian', 'sistema operativo', 'cuba', 'software libre', 'gnu', 'instalación', 'configuración', 'administración', 'escritorio', 'servidor', 'repositorios']
  },
  {
    id: 'cuba-sys-002',
    title: 'Redes de Computadoras en Instituciones Educativas Cubanas',
    authors: ['MSc. Luis García', 'Ing. Marta Pérez'],
    type: 'journal',
    category: 'Sistemas y Redes',
    tags: ['Redes', 'Educación', 'Cuba', 'Infraestructura', 'Conectividad'],
    abstract: 'Estudio sobre el diseño, implementación y gestión de redes de computadoras en centros educativos cubanos. Incluye arquitecturas recomendadas, políticas de seguridad y optimización de recursos limitados.',
    publishedYear: 2022,
    publisher: 'Revista Universidad 2000',
    citations: 78,
    impactFactor: 1.8,
    availability: 'digital-only',
    doi: '10.5281/cuba.u2000.2022.015',
    rating: 4.4,
    reviewCount: 45,
    language: 'es',
    pageCount: 22,
    thumbnail: 'https://images.pexels.com/photos/1148822/pexels-photo-1148822.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Infraestructura de Red', 'Educación', 'Gestión de Redes', 'WiFi'],
    digitalUrl: 'https://revista.mes.edu.cu/u2000/redes-educativas.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-SYS-002',
      barcode: 'CU31234567890210',
    ...
    fullTextKeywords: ['redes computadoras', 'instituciones educativas', 'cuba', 'diseño red', 'seguridad red', 'wifi', 'switches', 'routers', 'vlan', 'firewall', 'proxy', 'optimización ancho banda']
  },

  // BASES DE DATOS - ESPAÑOL
  {
    id: 'es-db-001',
    title: 'Diseño de Bases de Datos Relacionales: Teoría y Práctica',
    authors: ['Dr. Jorge Martínez', 'Ing. Silvia Ramírez'],
    type: 'book',
    category: 'Bases de Datos',
    tags: ['Bases de Datos', 'SQL', 'Modelado', 'Normalización', 'Español'],
    abstract: 'Libro completo sobre diseño de bases de datos relacionales en español. Cubre desde fundamentos teóricos hasta implementación práctica con SQL. Incluye múltiples ejercicios y proyectos reales.',
    publishedYear: 2023,
    publisher: 'Editorial Bases de Datos Hispana',
    citations: 312,
    availability: 'available',
    location: 'Sección Bases Datos Español, Estante 1',
    isbn: '978-84-123890-45-6',
    rating: 4.8,
    reviewCount: 456,
    language: 'es',
    pageCount: 612,
    thumbnail: 'https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['SQL', 'Normalización', 'Modelo Entidad-Relación', 'PostgreSQL', 'MySQL'],
    url: 'https://biblioteca.university.edu/catalog/diseno-bd-relacionales',
    digitalUrl: 'https://digital.library.edu/books/diseno-bd-relacionales.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-DB-001',
      barcode: 'ES31234567890211',
      acquisitionDate: '2023-07-20',
      lastUpdated: '2024-02-08',
      totalCopies: 7,
      availableCopies: 4,
    ...
    fullTextKeywords: ['bases datos', 'sql', 'diseño', 'modelado', 'normalización', 'modelo entidad relación', 'diagrama er', 'integridad referencial', 'consultas', 'transacciones', 'índices', 'optimización']
  },
  {
    id: 'es-db-002',
    title: 'MongoDB y NoSQL: Bases de Datos Orientadas a Documentos',
    authors: ['Ing. Ricardo Vega', 'MSc. Carolina Díaz'],
    type: 'book',
    category: 'Bases de Datos',
    tags: ['MongoDB', 'NoSQL', 'Bases de Datos', 'Documentos', 'Español'],
    abstract: 'Guía práctica de MongoDB y bases de datos NoSQL en español. Incluye patrones de diseño, optimización de consultas, replicación, sharding y casos de uso reales en aplicaciones web modernas.',
    publishedYear: 2023,
    publisher: 'Ediciones NoSQL Latam',
    citations: 167,
    availability: 'digital-only',
    isbn: '978-84-567123-89-0',
    rating: 4.7,
    reviewCount: 289,
    language: 'es',
    pageCount: 485,
    thumbnail: 'https://images.pexels.com/photos/1181679/pexels-photo-1181679.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['NoSQL', 'JSON', 'Escalabilidad', 'Big Data', 'Microservicios'],
    digitalUrl: 'https://digital.library.edu/books/mongodb-nosql-espanol.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-DB-002',
      barcode: 'ES31234567890212',
    ...
    fullTextKeywords: ['mongodb', 'nosql', 'bases datos documentos', 'json', 'bson', 'colecciones', 'agregación', 'pipeline', 'replicación', 'sharding', 'índices', 'escalabilidad', 'rendimiento']
  },

  // MATEMÁTICAS - ESPAÑOL
  {
    id: 'es-math-001',
    title: 'Matemáticas para Ciencias de la Computación',
    authors: ['Dr. Eduardo Suárez', 'Dra. Mercedes Luna'],
    type: 'book',
    category: 'Matemáticas para Computación',
    tags: ['Matemáticas Discretas', 'Álgebra Lineal', 'Teoría de Grafos', 'Español'],
    abstract: 'Libro de matemáticas enfocado en ciencias de la computación, escrito en español. Cubre matemáticas discretas, álgebra lineal, teoría de grafos, probabilidad y estadística con aplicaciones a la informática.',
    publishedYear: 2022,
    publisher: 'Editorial Matemática Aplicada',
    citations: 345,
    availability: 'available',
    location: 'Sección Matemáticas Español, Estante 2',
    isbn: '978-84-234567-12-3',
    rating: 4.6,
    reviewCount: 378,
    language: 'es',
    pageCount: 687,
    thumbnail: 'https://images.pexels.com/photos/1181681/pexels-photo-1181681.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Lógica', 'Combinatoria', 'Algoritmos', 'Complejidad Computacional'],
    url: 'https://biblioteca.university.edu/catalog/matematicas-computacion',
    digitalUrl: 'https://digital.library.edu/books/matematicas-computacion.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-MATH-001',
      barcode: 'ES31234567890213',
    ...
    fullTextKeywords: ['matemáticas discretas', 'álgebra lineal', 'teoría grafos', 'lógica', 'conjuntos', 'relaciones', 'funciones', 'combinatoria', 'probabilidad', 'estadística', 'matrices', 'vectores']
  },

  // INGENIERÍA SOFTWARE - CUBA
  {
    id: 'cuba-sw-001',
    title: 'Metodología de Desarrollo de Software en Cuba: Experiencias UCI',
    authors: ['Dr. Raúl Castro Martínez', 'Dra. Gladys León'],
    type: 'book',
    category: 'Ingeniería de Software',
    tags: ['Ingeniería Software', 'Metodología', 'Cuba', 'UCI', 'Scrum', 'RUP'],
    abstract: 'Recopilación de metodologías y mejores prácticas de ingeniería de software desarrolladas en la Universidad de las Ciencias Informáticas (UCI) de Cuba. Incluye adaptaciones de Scrum, RUP y metodologías ágiles al contexto cubano.',
    publishedYear: 2023,
    publisher: 'Editorial UCI',
    citations: 156,
    availability: 'available',
    location: 'Sección Ingeniería Software Cubana, Estante 1',
    isbn: '978-959-16-3456-7',
    rating: 4.5,
    reviewCount: 123,
    language: 'es',
    pageCount: 398,
    thumbnail: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Metodologías Ágiles', 'Gestión de Proyectos', 'Calidad de Software', 'Pruebas'],
    url: 'https://biblioteca.uci.cu/metodologia-desarrollo-software',
    digitalUrl: 'https://biblioteca.uci.cu/digital/metodologia-desarrollo.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-SW-001',
      barcode: 'CU31234567890214',
    ...
    fullTextKeywords: ['ingeniería software', 'metodología', 'cuba', 'uci', 'scrum', 'rup', 'metodologías ágiles', 'gestión proyectos', 'calidad software', 'pruebas', 'desarrollo', 'ciclo vida']
  },

  // TECNOLOGÍAS EMERGENTES - ESPAÑOL
  {
    id: 'es-emerging-001',
    title: 'Internet de las Cosas: Fundamentos y Aplicaciones en Español',
    authors: ['Ing. Alberto Méndez', 'Dr. Francisco Torres'],
    type: 'book',
    category: 'Tecnologías Emergentes',
    tags: ['IoT', 'Internet de las Cosas', 'Sensores', 'Arduino', 'Español'],
    abstract: 'Libro completo sobre Internet de las Cosas (IoT) en español. Cubre desde conceptos básicos hasta implementaciones prácticas con Arduino, Raspberry Pi y plataformas en la nube. Incluye proyectos aplicados a smart cities y agricultura.',
    publishedYear: 2023,
    publisher: 'Ediciones IoT Hispana',
    citations: 198,
    availability: 'digital-only',
    isbn: '978-84-890123-45-6',
    rating: 4.7,
    reviewCount: 267,
    language: 'es',
    pageCount: 512,
    thumbnail: 'https://images.pexels.com/photos/1181707/pexels-photo-1181707.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Sensores', 'Microcontroladores', 'Smart Cities', 'Industria 4.0'],
    digitalUrl: 'https://digital.library.edu/books/iot-fundamentos-espanol.pdf',
    librarySystem: {
      catalogId: 'CAT-ES-EMERGING-001',
      barcode: 'ES31234567890215',
      ...
      digitalAccess: true,
      digitalLicenses: 25,
      digitalActiveUsers: 13
    },
    fullTextKeywords: ['internet cosas', 'iot', 'sensores', 'actuadores', 'arduino', 'raspberry pi', 'mqtt', 'protocolos', 'comunicación', 'smart cities', 'domótica', 'agricultura inteligente', 'industria 4.0']
  },
  {
    id: 'cuba-emerging-001',
    title: 'Blockchain para Gobiernos: Casos de Uso en América Latina',
    authors: ['Dr. Manuel Ortega', 'Ing. Carla Hernández'],
    type: 'conference',
    category: 'Tecnologías Emergentes',
    tags: ['Blockchain', 'Gobierno Digital', 'América Latina', 'Cuba', 'Transparencia'],
    abstract: 'Análisis de casos de uso de blockchain en gobiernos latinoamericanos, con especial énfasis en transparencia, trazabilidad y gobierno electrónico. Incluye experiencias piloto en Cuba y propuestas de implementación.',
    publishedYear: 2023,
    publisher: 'Conferencia Latinoamericana de Tecnología Blockchain',
    citations: 87,
    impactFactor: 2.3,
    availability: 'digital-only',
    rating: 4.4,
    ...
    language: 'es',
    pageCount: 16,
    thumbnail: 'https://images.pexels.com/photos/1181704/pexels-photo-1181704.jpeg?auto=compress&cs=tinysrgb&w=300',
    relatedTopics: ['Gobierno Electrónico', 'Criptomonedas', 'Smart Contracts', 'Descentralización'],
    digitalUrl: 'https://conferencias.blockchain-latam.org/2023/blockchain-gobiernos.pdf',
    librarySystem: {
      catalogId: 'CAT-CUBA-EMERGING-001',
      barcode: 'CU31234567890216',
